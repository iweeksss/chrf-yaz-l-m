...
function CHRFLib:CreateWindow(hubName)
    ...
    -- [[ AKTİF MODLAR PANELİ (ARKA PLAN ŞEFFAF) ]]
    local ActiveModsFrame = Instance.new("Frame", ScreenGui)
    ActiveModsFrame.BackgroundTransparency = 1 -- Arka plan gizlendi
    ...
    -- Göstergeleri Taşıma Kontrolü (Dışarıdan açılıp kapanacak)
